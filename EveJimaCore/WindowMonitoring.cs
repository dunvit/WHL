...
namespace EveJimaCore
{
    public partial class WindowMonitoring : Form
    {
        ...
        {
            Log.ErrorFormat("[WindowMonitoring.WindowMonitoring] Critical error {0}", "!!!");
            try
            {
        ...
        private void WindowMonitoring_Load(object sender, EventArgs e)
        {
            ...
            //Global.InternalBrowser.Browser = new whlBrowser(OpenWebBrowserPanel);
        ...
        private bool IsNeedUpdateApplication()
        {
            ...
            try
            {
                ...
                if (Global.Settings.Version != Global.Settings.CurrentVersion.Trim())
                {
                    ...
                    //MessageBox.Show("New version " + Global.Settings.Version + " ready for download.");
        ...
        {
            //Global.InternalBrowser.Browser.Dispose();
