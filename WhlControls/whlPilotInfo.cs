...
namespace WHL.WhlControls
{
    public partial class whlPilotInfo : UserControl
    {
        ...
        private void cmdShowZkillboard_Click(object sender, EventArgs e)
        {
            ...
            Global.Browser.BrowserUrlExecute("https://zkillboard.com/character/" + characterId + "/");
        }
        ...
        private void cmdShowEveHunt_Click(object sender, EventArgs e)
        {
            ...
            Global.Browser.BrowserUrlExecute("http://eve-hunt.net/hunt/" + txtSelectedPilotName.Text.Trim() + "/");
        }
